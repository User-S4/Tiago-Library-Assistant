...
: ${AMENT_CURRENT_PREFIX:="/opt/erc_ws/install/pal_pro_gripper_bringup"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/pal_pro_gripper_bringup/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/pal_pro_gripper_bringup/environment/path.sh"
