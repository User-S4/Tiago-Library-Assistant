...
: ${AMENT_CURRENT_PREFIX:="/opt/erc_ws/install/omni_base_controller_configuration"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/omni_base_controller_configuration/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/omni_base_controller_configuration/environment/path.sh"
