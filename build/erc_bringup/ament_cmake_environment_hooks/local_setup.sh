...
: ${AMENT_CURRENT_PREFIX:="/opt/erc_ws/install/erc_bringup"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/erc_bringup/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/erc_bringup/environment/path.sh"
