...
: ${AMENT_CURRENT_PREFIX:="/opt/erc_ws/install/pal_sea_arm_bringup"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/pal_sea_arm_bringup/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/pal_sea_arm_bringup/environment/path.sh"
