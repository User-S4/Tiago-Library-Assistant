...
: ${AMENT_CURRENT_PREFIX:="/opt/erc_ws/install/tiago_pro_robot"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/tiago_pro_robot/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/tiago_pro_robot/environment/path.sh"
